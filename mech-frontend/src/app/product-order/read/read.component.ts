...
import { ProductOrderService } from 'src/app/service/product-order.service';
...
export class ReadComponent implements OnInit {
  ...
  constructor(private employeeService: EmployeeService,
    ...
    private service: ProductOrderService,
  ...
  goCreate(){
    this.router.navigate(["product-order/create"]);
  }

  goUpdate(object:Object):void{
    localStorage.setItem("id",object.id.toString());
    this.router.navigate(["product-order/update"]);
  }
